  ...
  render() {
    ...
    return (
      <form noValidate>
        ...
        <Grid item >
          <Button onClick={onAddTodo} variant='contained' color='primary' startIcon={<SaveIcon />}>add</Button>&nbsp;&nbsp;
         <Button onClick={onUpdateTodo} variant='contained' color='default' startIcon={<UpdateIcon />}>Update</Button>&nbsp;&nbsp;
         <Button onClick={onRemoveTodo} variant='contained' color='secondary' startIcon={<DeleteIcon />}>Delete</Button>&nbsp;&nbsp;
